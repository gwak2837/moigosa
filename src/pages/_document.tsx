...
export const canonicalUrl = 'https://moigosa.vercel.app/'

// 최대 10개
const keywords = '수능,모의고사,영어'

export default class MoigosaDocument extends Document {
    ...
    return (
      <Html>
        <Head>
          ...
          <meta name="application-name" content="수능 모의고사" />
          <meta name="theme-color" content={PRIMARY_BACKGROUND_COLOR} />
          <meta name="apple-mobile-web-app-capable" content="yes" />
          <meta name="apple-mobile-web-app-title" content="수능 모의고사" />
